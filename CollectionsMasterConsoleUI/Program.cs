    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            var numberList = new List<int>(50);
            ...
            var searchNumber = 0;
            var isNumber = int.TryParse(Console.ReadLine(), out searchNumber);
            if (!isNumber)
            {
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            Console.WriteLine((isInList == true) ? $"Your number {searchNumber} is in the number list!" : $"Your number {searchNumber} is not in the list.");
        ...
        private static void ReverseArray(int[] numbers)
        {
            ...
            {
                int temporaryInt = numbers[i];
                numbers[i] = numbers[numbers.Length - i - 1];
                numbers[numbers.Length - i - 1] = temporaryInt;
            }
        }
